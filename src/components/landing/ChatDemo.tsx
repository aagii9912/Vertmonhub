...
const SCRIPT: Msg[] = [
    ...
    {
        from: 'ai',
        text: '160 сая₮ байрны хувьд 6%-ийн орон сууцны зээлээр сард ≈980,000₮. Үзлэг товлох уу? 😊',
    },
];
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-16">
                <Reveal>
                    ...
                    <p className="mt-4 max-w-md text-base leading-relaxed text-muted-foreground">
                        Харилцагч асуумагц AI борлуулагч хариулж, орон сууц санал болгож, зээлийн тооцоо хийж, үзлэг
