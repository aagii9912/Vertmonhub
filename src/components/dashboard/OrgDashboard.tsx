...
interface OrgDashboardProps {
    /** Контейнерын доод хэсэгт нэмж рэндэрлэх блок (ж: багийн гүйцэтгэл + менежер сонгогч). */
    extra?: React.ReactNode;
}

/**
 * Нэгдсэн (байгууллагын) дашбоард — shop-ийн түвшний KPI, сүүлийн лидүүд,
 * багийн зорилт, ойрын уулзалтууд. Админ болон менежер бус role-уудад харагдана.
 */
export function OrgDashboard({ extra }: OrgDashboardProps) {
    ...
    return (
        <PullToRefresh onRefresh={handleRefresh}>
            <div className="mx-auto w-full max-w-[1440px] space-y-6 md:space-y-8">
                ...
                {/* Нэмэлт блок (ж: багийн гүйцэтгэл + менежер сонгогч) */}
                {extra}
            </div>
        </PullToRefresh>
    );
