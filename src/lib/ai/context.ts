...
export function suggestionsFor(ctx: AiContext | null): AiSuggestion[] {
    switch (ctx?.type) {
        case 'lead': {
            ...
            return [
                { label: 'Дуудлага бүртгэх', prompt: `${n} лидтэй ярьсан дуудлага, үр дүн, дараагийн холбогдох цагийг бүртгэ: ` },
        ...
        default:
            return [
                { label: 'Ажил нэмэх', prompt: 'Миний хийх ажил, дуусах хугацаа, сануулгыг бүртгэ: ' },
                { label: 'Нэгдсэн тайлан', prompt: 'Үйл ажиллагааны нэгдсэн тайлангаас энэ сарын гэрээний дүн, зорилтын биелэлт, бодитоор бүртгэгдсэн мөнгөн орлого, урьдчилгаа болон анхаарах лидүүдийг нэгтгэ. Огноо, мэдээллийн хүрээг тодорхой хэл.' },
