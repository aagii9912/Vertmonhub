...
## ХЭРЭГЖИЛТИЙН ТӨЛӨВ (2026-08-22)

> Энэ баримтын **Фаз 0–4 бүгд хэрэгжиж**, `claude/odoo-sales-manager-issue-ved2oo`
> салбарт push хийгдсэн. Доорх төлөвлөгөө нь одоо түүхэн үндэслэл ба
> шийдвэрийн бүртгэл болж үлдэнэ.

| Фаз | Төлөв | Гол хүргэлт |
|-----|-------|-------------|
| 0 — Яаралтай засвар | ✅ | AI-ийн 0₮ орлого, мобайл чат, auth bootstrap, нэрийн нормчлол, onboarding тайлбар, дагалт, push, /marketing хамгаалалт |
| 1 — AI-аар ажиллах суурь | ✅ | «Миний ажил» agent + 10 tool, идэвхийн бүртгэл, agent зэрэгцүүлэлт, SSE streaming |
| 2 — Ролиуд | ✅ | TOOL_MODULE_MAP, allowedAgentsFor, executive роль |
| 3 — Хяналтын давхарга | ✅ | activity_log, /api/dashboard/activity, computeAnomalies, anomaly-watch cron, «Хяналтын зөвлөх» agent |
| 4 — Бататгал | ✅ | config/models.ts, 37 шинэ тест, CLAUDE.md |

**Хэрэгжүүлэлтийн явцад төлөвлөгөөнөөс ЗӨРСӨН шийдвэрүүд:**

1. **Уулзалтын үр дүнд шинэ багана НЭМЭЭГҮЙ.** §5-д `property_viewings`-д
   `outcome`/`outcome_note`/`completed_at` нэмэхээр байсан ч кодыг шалгахад
   эдгээр аль хэдийн байсан (`status`, `completed_at`, `customer_feedback`,
   `interest_level`). Жинхэнэ дутагдал нь схем биш, тэдгээрийг бөглөх **API/tool**
   байв — тэрийг нэмсэн.
2. **OAuth-ыг хаагаагүй, харин баталгаажуулалттай болгосон** (§6.3-ын (а) биш
   (б)). Гэхдээ нэвтэрсэн бүрийг shop-д нэмэхгүй — зөвхөн админ аль хэдийн
   баталгаажуулсан (user_roles эсвэл sales_managers.user_id) хүнд. Танихгүй
   хүн профайлтай болно ч төсөлд холбогдохгүй, дашбоард нь шалтгааныг тайлбарлана.
3. **Хувь хүний зорилт (§5.3), approvals/entity_comments (§5.4),
   report_subscriptions (§5.5), uuid attribution (§5.8)** нь хэрэгжээгүй —
   эдгээр нь §6.2 ба §6.4-ийн **эзний шийдвэр** хүлээж байгаа зүйлс
   (аль үйлдэл зөвшөөрөл шаардах вэ; түүхэн гэрээний эзнийг хэн батлах вэ).
4. **Дуудлагын бүртгэл гараар** (§6.6-ийн зөвлөмжөөр) — телефон интеграци
   хийгээгүй.

**Хэрэгжүүлсний дараа шүүмжлэлт шалгалтаар илэрч зассан зүйлс** (10 агент,
24 баталгаажсан илрүүлэлт): rate limit тойрох боломж, төсвийг үнэ болгож
бичих гажуудал, OAuth-аар танихгүй хүн shop-д орох, roster-ийн буруу холбоос,
`log_activity`-ийн shop scoping, `user_tasks.source` дутуу багана,
`ai_audit_log`-ийн хэт нээлттэй RLS, marketing модулийн seed дутуу.
