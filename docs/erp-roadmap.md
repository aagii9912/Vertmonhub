...
> **Төлөв:** Phase 1 (Санхүүгийн цөм), Phase 2 AP цөм (нийлүүлэгч/нэхэмжлэх/төлөлт),
> Phase 3 (Төслийн өртөг & Төсөв — гэрээ↔төсөл, project budgets, P&L roll-up) хэрэгжсэн.
> Үлдсэн: худалдан авалтын захиалга (PO), бүрэн AP aging bucket. Phase 4 хүлээгдэж буй.
