...
> **Төлөв:** Phase 1–4 бүгд хэрэгжсэн ✅ (P1 санхүүгийн цөм, P2 AP/худалдан авалт,
> P3 төслийн өртөг & төсөв, P4 санхүүгийн тайлан — P&L/мөнгөн урсгал/НӨАТ/AR-AP aging +
> Excel export + audit + finance/accountant role).
> Хойшлуулсан: худалдан авалтын захиалга (PO→bill), давхар бичилтийн GL, банкны тулгалт.
