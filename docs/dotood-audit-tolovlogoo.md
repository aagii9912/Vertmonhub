...
#### C-1. Гэрээг бүрмөсөн устгах нь эрхийн шалгалтгүй, ул мөргүй

`src/app/api/dashboard/contracts/[id]/route.ts:50-56`

```ts
const authShop = await getUserShop();          // ← зөвхөн «нэвтэрсэн үү»
...
`requireDelete()` дуудагдахгүй, аудит бичигдэхгүй, зөөлөн устгал биш. Дэлгүүрийн **дурын гишүүн** (тэр дундаа `canDelete: false` дүртэй `sales_manager`) гэрээг бүрмөсөн устгана. Каскадаар төлбөрийн хуваарь, хүлээлцэх акт устаж, кассын гүйлгээ өнчирнө. Сэргээх ч боломжгүй, хэн хийснийг мэдэх ч боломжгүй.
...
### Үе 0 — Яаралтай (1–2 өдөр) ⚠️ эхлээд

Хамгийн бага хөдөлмөрөөр хамгийн том эрсдэл. Ихэнх нь код хасах эсвэл хэдэн мөр нэмэх ажил.

| # | Ажил | Олдвор |
|---|---|---|
| 0.1 | `vertmon-session` хүлээн авах **бүх** замыг устгах | C-5, H-10 |
| 0.2 | `analyze-messages`-д `getUserShop()` заавал; `shopId`-г биеэс авахаа болих | C-4 |
| 0.3 | `admin/users` PATCH-д дүрийн цагаан жагсаалт + `super_admin` шалгалт | C-3 |
| 0.4 | Гэрээний DELETE-д `requireDelete()` нэмэх, hard delete → `deleted_at` | C-1 |
| 0.5 | `instrumentation.ts` нэмж Sentry-г амилуулах, `next.config.ts`-д `withSentryConfig` | C-7 |
| 0.6 | DM AI `check_payment_status`-ыг таних тэмдэгээр хязгаарлах эсвэл түр хаах | C-6 |
| 0.7 | Instagram token-ыг лог руу хэвлэхээ болих; `auth/instagram/accounts`-д auth нэмэх | H-8, H-9 |
| 0.8 | `CRON_SECRET` тохируулаагүй үед production-д **татгалзах**; `timingSafeEqual` | H-11 |
| 0.9 | Upload-д MIME цагаан жагсаалт + хэмжээний хязгаар | H-12 |

> 0.1 нь код хасах ажил тул регресс эрсдэл бага. Гэхдээ Supabase Auth сесс бүрэн ажиллаж байгааг эхлээд баталгаажуулна.
