...
- **AI нөөцийн тоо:** production smoke-оор илэрсэн хуучин зарын `properties` сангийн тооллогыг dashboard-тай ижил `property_units`, `residential` ангиллаар засав. Нийт/боломжтой/зарагдсан/хүлээгдэж буй тоо, эх сурвалж ба ангилал тодорхой. Гэрээ, лид, нөөц бүх хуудсаа уншина; query алдааг тэг гэж тайлбарлахгүй. Гэрээний үнийн нийлбэрийг мөнгөн орлого гэж нэрлэхгүй.
...
- `7065281`-ийн GitHub CI бүх алхам амжилттай: [run 34766609303](https://github.com/aagii9912/Vertmonhub/actions/runs/34766609303).
- Нэвтэрсэн production agents API `provider=openai`, `model=gpt-5.6-luna`, `configured=true`. Эхний унших AI хүсэлт 4.9 секундэд дуусаж, зөвхөн `get_dashboard_stats` ажилласан. Энэ smoke хуучин нөөцийн эх сурвалжийн алдааг илрүүлсэн тул дээрх засварын дараа давтан шалгана.
- Нэвтэрсэн finance summary, contracts, operations report GET хүсэлтүүд 200. Бодит төлбөр/бизнес бүртгэл үүсгээгүй.
- Runtime логийн `TOKEN_ENCRYPTION_KEY` дутуу тохиргоог засав. Хадгалсан шифрлэгдсэн токеныг тайлдаг **яг өмнөх secret bytes**-ийг тусдаа Sensitive production env болгон хадгалсан; токены мөрийг өөрчлөөгүй. Энэ түлхүүрийн whitespace-ийг цэвэрлэх эсвэл backfill-гүй солих нь өмнөх токеныг эвдэнэ. Vercel env CLI stdin-ийн төгсгөлийн newline-ийг хасдаг тул энэ утгыг JSON API body-оор яг хэвээр дамжуулсан.
