...
> **Төлөв:** Phase 1 (багийн хэрэглэгч), Phase 2 (цэвэр/dedup сан), Phase 3 (чанарын
> скоринг + lifecycle + автомат дагалт), Phase 4 (юүлүүрийн холболт: lead→гэрээ)
> хэрэгжсэн. Phase 5 нь хүлээгдэж буй замын зураг.
