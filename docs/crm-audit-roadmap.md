...
> **Төлөв:** Phase 1–5 бүгд хэрэгжсэн ✅ (P1 багийн хэрэглэгч, P2 цэвэр/dedup сан,
> P3 чанарын скоринг+lifecycle+автоматжуулалт, P4 юүлүүрийн холболт lead→гэрээ,
> P5 метрик цэгцлэх + хуучин үлдэгдэл устгах). Хойшлуулсан: түүхэн метрик snapshot,
> AI analytics UI, monthlyViewings field-ийн нэр солих (`docs/metrics-reference.md`-д тэмдэглэв).
